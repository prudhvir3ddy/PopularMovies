...
import com.example.prudhvi.popularmovies.Adapters.ReviewsAdapter;
import com.example.prudhvi.popularmovies.Adapters.TrailersAdapter;
import com.example.prudhvi.popularmovies.Models.Reviews_Model;
import com.example.prudhvi.popularmovies.Models.Trailers_Model;
...
import com.example.prudhvi.popularmovies.data.MoviesContract;
...
@BindView(R.id.Movie_title)   TextView T_title;
    ...
    @BindView(R.id.trailers_recyclerview) RecyclerView t_recyclerView;
    @BindView(R.id.reviews_recyclerView) RecyclerView r_recyclerView;
